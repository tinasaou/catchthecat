...
namespace CatchTheCat {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class GameDataTable : global::System.Data.TypedTableBase<GameRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public GameRow AddGameRow(string name, string score) {
        ...
        public partial class GameRow : global::System.Data.DataRow {
            ...
            public string score {
                get {
                    try {
                        return ((string)(this[this.tableGame.scoreColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace CatchTheCat.Database1DataSetTableAdapters {
    ...
    public partial class GameTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Game` WHERE ((`ID` = ?) AND ((? = 1 AND `name` IS NULL) OR (`name` =" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Game` (`name`, `score`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Game` SET `name` = ?, `score` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `name" +
                "` IS NULL) OR (`name` = ?)) AND ((? = 1 AND `score` IS NULL) OR (`score` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CatchTheCat.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, name, score FROM Game";
